...
builder.Services.AddScoped<OtDocumentOrderHandler>();
...
builder.Services.AddScoped<ProcedureTypeIndexHandler>();
builder.Services.AddScoped<ProcedureTypeCrudHandler>();
