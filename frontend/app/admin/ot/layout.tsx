...
export default async function AdminOtLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
      <FlitCard>
        ...
        <p className="mt-2 text-sm text-flit-text-secondary">
          La consola de organismos de tránsito está disponible solo para Super Administrador.
        </p>
